...
FROM suppliers;
-- Para marcar cuál es cliente y cual proveedor, nos fijamos en el id.
...
En este caso, nuestro jefe quiere saber cuantas empresas no han comprado en el año 1997.*/
-- Year
...
Estamos muy interesados en saber como ha sido la evolución de la venta de Konbu a lo
 largo del tiempo. Nuestro jefe nos pide que nos muestre todos los pedidos que contengan "Konbu".
💡 Pista 💡 En esta query tendremos que combinar conocimientos adquiridos en las lecciones
